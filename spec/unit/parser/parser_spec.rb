...
describe Puppet::Parser do
  ...
  describe "when parsing classes" do
    ...
    it "should correctly set the parent class when one is provided" do
      @parser.parse("class foobar inherits yayness {}").code[0].instantiate(Puppet::Module::NullModule.instance)[0].parent.should == "yayness"
    end
    ...
    it "should correctly set the parent class for multiple classes at a time" do
      ...
      statements[0].instantiate(Puppet::Module::NullModule.instance)[0].parent.should == "yayness"
      statements[1].instantiate(Puppet::Module::NullModule.instance)[0].parent.should == "bar"
    end
    ...
    it "should define parameters when provided" do
      foobar = @parser.parse("class foobar($biz,$baz) {}").code[0].instantiate(Puppet::Module::NullModule.instance)[0]
  ...
  it "should treat classes as case insensitive" do
    @parser.known_resource_types.import_ast(@parser.parse("class yayness {}"), Puppet::Module::NullModule.instance)
  ...
  it "should treat defines as case insensitive" do
    @parser.known_resource_types.import_ast(@parser.parse("define funtest {}"), Puppet::Module::NullModule.instance)
